...
(function($){
  ...
  $.hoverSlider = function($monthsSliders, settings) {
    var $monthsSliders = $($monthsSliders),
        $slider = $monthsSliders.children("div"),
        $slides = $slider.children("div"),
        $wrapperWidth = $monthsSliders.outerWidth(),
        $sliderWidth = 0,
    ...
    var watchers = function() {
      ...
      $monthsSliders.mousemove(function(event) {
        ...
        mouseMoveTimeout = setTimeout(function() {
          ...
          var paddingPercentage = ((parseInt(settings.mouseMovePaddingPercent) / Math.pow(10, 2)) / 2) * $wrapperWidth,
              leftVal = $sliderWidth * (((event.pageX - ($monthsSliders.offset().left + paddingPercentage)) / ($wrapperWidth - (paddingPercentage * 2))) * -1);
      ...
      if(settings.resetOnMouseout) {
        $monthsSliders.mouseout(function(event) {
